...
def get_stock_analysis(ticker):
    ...
    print("RAW RESPONSE:", res.status_code, res.text)
    data = res.json()
...
st.set_page_config(
    page_title="FinFluent: Stock Analysis and Sentiment", page_icon="📈", layout="centered"
)
...
st.write(
    "Enter a stock ticker symbol to get the latest analysis and sentiment overview."
)
